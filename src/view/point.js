...
export const createPointTemplate = ({ basePrice, dateFrom, dateTo, destination, isFavorite, offers, type }) => {
  ...
  const durationHours = Math.floor(duration / MINUTES_IN_HOUR);
  const durationMinuts = duration % MINUTES_IN_HOUR;
  ...
  <li class="trip-events__item">
    <div class="event">
      ...
      <div class="event__schedule">
        ...
        <p class="event__duration">${durationHours ? durationHours + 'H' : ''} ${durationMinuts ? durationMinuts + 'M' : ''}</p>
      </div>
